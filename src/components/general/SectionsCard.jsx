	...
	return (
		<div className="collapse collapse-arrow bg-accent ease-in-out w-11/12 2xs:w-9/12 sm:w-8/12 md:w-7/12 lg:w-1/2 xl:rounded-xl 2xl:rounded-3xl">
			...
			<div className="collapse-content flex flex-col items-center text-base-100">
				...
				<button className="botao mt-4 3xs:mt-5 3xs:mb-2 2xs:mt-7 2xs:mb-4 xs:mt-6 xs:mb-3 lg:mt-7 lg:my-4 xl:mt-8 xl:mb-5 2xl:mt-12 2xl:mb-8 !bg-neutral p-0 rounded-lg sm:rounded-xl 2xl:rounded-2xl 3xl:rounded-3xl !shadow-2xl">
					<Link
						to={`/${query}`}
						className="block p-0 text-lg 3xs:text-xl 2xs:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl !bg-neutral rounded-lg sm:rounded-xl 2xl:rounded-2xl 3xl:rounded-3xl py-2 sm:py-3 xl:py-5 3xl:py-7 px-5 xs:px-6 sm:px-7 xl:px-9 3xl:px-12 !shadow-lg">
						Ir para a seção
					</Link>
				</button>
			</div>
