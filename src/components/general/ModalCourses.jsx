	...
	return (
		<>
			...
			<dialog
				...
				<div className="modal-box px-6 2xs:px-4 sm:px-6 md:px-5 2xl:px-6 3xl:py-8 2xs:pt-6 py-3 sm:py-5 2xl:py-6 3xl:px-8 !max-w-fit sm:w-4/5 md:w-3/5 2xl:w-2/5 bg-accent !shadow-2xl 2xs:py-4 sm:rounded-3xl transition-opacity duration-500 ease-in-out">
					{!imageSrc && (
					...
					<div className="modal-action w-full mt-0">
						<form method="dialog" className="w-full flex justify-center">
							<button
								className={`${
									imageSrc
										? "botao flex justify-center items-center text-lg 4xs:text-xl xs:text-2xl md:text-xl lg:text-3xl xl:text-4xl 3xl:text-5xl 2xl:px-10 3xl:min-h-20 text-base-100 !bg-secondary !shadow-2xl py-2 px-4 xs:py-3 xs:px-6 sm:py-3 sm:px-7 xl:py-4 xl:px-10 3xl:px-16 3xl:py-5 xl:rounded-2xl 2xs:-mt-1 xs:-mt-1 xs:mb-0 sm:mt-0 sm:-mb-1 md:-mb-1 md:mt-0 lg:mt-2 lg:mb-2 2xl:mb-3"
										: "botao flex justify-center items-center text-lg 4xs:text-xl xs:text-2xl md:text-xl lg:text-3xl xl:text-4xl 3xl:text-5xl 2xl:px-10 3xl:min-h-20 text-base-100 !bg-secondary !shadow-2xl py-2 px-4 xs:py-3 xs:px-6 xs:mt-1 xs:mb-2 sm:py-3 sm:px-7 xl:py-4 xl:px-10 3xl:px-16 3xl:py-5 xl:rounded-2xl 2xs:mt-1 sm:-mt-2 md:mb-1"
								}`}>
								Fechar
							</button>
						</form>
					</div>
					<div className={`w-full flex justify-center ${imageSrc && "2xs:hidden"}`}>
