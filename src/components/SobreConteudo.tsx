	...
	return (
		<>
			<div className="space-y-12 sm:space-y-16">
				{/* ... (Cabeçalho e Minha Jornada - sem alterações) ... */}
				<header className="container mx-auto px-4 pt-4 text-center sm:px-6 lg:px-8">
					<h1 className="font-heading text-4xl font-bold text-light-text dark:text-dark-text sm:text-5xl md:text-6xl 2xl:text-7xl">
						Sobre Mim
					</h1>
					<div className="mx-auto mt-4 max-w-3xl space-y-2 text-lg text-light-text/80 dark:text-dark-text/80 sm:text-xl 2xl:text-2xl">
						<p>
							Olá! Este é o meu espaço para compartilhar minha jornada no desenvolvimento de
							software e os projetos que venho construindo.
						</p>
						<p>Navegue pelas seções para saber mais.</p>
					</div>
				</header>
